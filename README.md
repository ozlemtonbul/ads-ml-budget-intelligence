...
The system was built for a children's footwear brand operating across four sales channels (Web, Hepsiburada, Trendyol, LCW) and covers product categories including Preschool, Baby, Kids, and First Steps.
...
| ML models | scikit-learn Random Forest Regression (x2) |
